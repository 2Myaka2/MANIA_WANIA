...
| `k-means`, `silhouette` | Conformation | Analysis v1.3 reference | `docs/notebook_gap_report_v1_3.md` — records both as deferred. | missing | MVP candidate | MANIA scientific MVP | Stage 22.E does not cluster, select k, label conformations, or select representatives. | Stage 22.F only after explicit approval |
